...
export const env = {
  ...
  geminiTtsVoiceDefault: process.env.GEMINI_TTS_VOICE_DEFAULT ?? "Zephyr",
  geminiTtsVoicePlayful: process.env.GEMINI_TTS_VOICE_PLAYFUL ?? "Puck",
  geminiTtsVoiceWise: process.env.GEMINI_TTS_VOICE_WISE ?? "Kore",
  geminiTtsVoiceAdventurous: process.env.GEMINI_TTS_VOICE_ADVENTUROUS ?? "Zephyr",
  geminiTtsVoiceInventor: process.env.GEMINI_TTS_VOICE_INVENTOR ?? "Charon",
